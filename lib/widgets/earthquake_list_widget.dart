...
class EarthquakeListWidget extends StatefulWidget {
  ...
  final bool showAppBar; // If false, renders a custom header
  final VoidCallback? onLocationRefresh;
  final Function(Earthquake)? onEarthquakeTap;
  ...
  const EarthquakeListWidget({
    ...
    this.onEarthquakeTap,
  });

  @override
  State<EarthquakeListWidget> createState() => EarthquakeListWidgetState();
}

class EarthquakeListWidgetState extends State<EarthquakeListWidget> {
  // UI State
  ...
  Widget build(BuildContext context) {
    return Consumer<EarthquakeProvider>(
      builder: (context, provider, child) {
        ...
        return Column(
          children: [
            if (!widget.showAppBar) _buildCustomHeader(provider),
                  ...
                  provider.listEarthquakes.isEmpty
                      ...
                      : RefreshIndicator(
                        ...
                        child: ListView.builder(
                          ...
                          cacheExtent:
                              800, // Increased cache for smoother scrolling
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return RepaintBoundary(
                              child: EarthquakeListItem(
                                ...
                                onTap: () {
                                  if (widget.onEarthquakeTap != null) {
                                    widget.onEarthquakeTap!(earthquake);
                                  } else {
                                    Navigator.push(
                                      context,
  ...
  Widget _buildCustomHeader(EarthquakeProvider provider) {
    return Container(
